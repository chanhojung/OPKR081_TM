...
if not EnableLogger:
  ...
  _AWARENESS_TIME = 350.  # one minute limit without user touching steering wheels make the car enter a terminal status
_AWARENESS_PRE_TIME_TILL_TERMINAL = 120.  # a first alert is issued 15s before expiration
